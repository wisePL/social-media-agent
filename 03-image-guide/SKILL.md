...
- 플랫폼별 이미지 스펙 제공 (Twitter/X, Instagram, Facebook, LinkedIn, Discord)
- **같은 크리에이티브 → 채널별 비율 배리에이션** 방식으로 디자이너에게 요청
...
> **핵심 원칙: 같은 크리에이티브, 비율만 배리에이션**
> 디자이너에게 메인 소재 1개 제작 후 채널별 비율로 크롭/조정 요청.
> 모든 에셋의 **핵심 요소(로고, 텍스트, 주인공)는 중앙 안전존**에 배치할 것.

### 채널별 필수 산출물 요약

| 채널 | 타겟 | 메인 사이즈 | 비율 |
|------|------|------------|------|
| Twitter/X | Web3 | 1600×900px | 16:9 |
| Instagram Feed | Web2 | 1080×1080px | 1:1 |
| Instagram Story | Web2 | 1080×1920px | 9:16 |
| Facebook | Web2 | 1200×630px | ~1.91:1 |
| LinkedIn | B2B | 1200×628px | ~1.91:1 |
| Discord | Community | 1280×720px | 16:9 |

> Facebook과 LinkedIn은 사이즈가 거의 동일 → 하나로 통용 가능.
> Twitter와 Discord도 16:9로 동일 → 1개 파일 공유 가능.
...
| 2장 멀티 이미지 | 각 **900×900px** | PNG / JPG | 5MB | 나란히 표시 |
| 4장 그리드 | 각 **1200×675px** | PNG / JPG | 5MB | 패치노트 세부 내용용 |

**인사이트:** 이미지 퀄리티 낮으면 텍스트 온리가 나음 — 고품질 이미지 or 텍스트 중 택일.

### Instagram

| 에셋 유형 | 권장 사이즈 | 파일 형식 | 비고 |
|-----------|-------------|-----------|------|
| Feed 스퀘어 (기본) | **1080×1080px** (1:1) | JPG / PNG | 가장 범용적 |
| Feed 세로 (Portrait) | **1080×1350px** (4:5) | JPG / PNG | 피드 점유율↑, 권장 |
| Story / Reels | **1080×1920px** (9:16) | JPG / MP4 | 전체화면 |

**인사이트:** 4:5 세로형이 피드에서 더 많은 화면 점유 → 가능하면 1:1보다 4:5 선호.

### Facebook

| 에셋 유형 | 권장 사이즈 | 파일 형식 | 비고 |
|-----------|-------------|-----------|------|
| 피드 이미지 | **1200×630px** (1.91:1) | JPG / PNG | 링크 미리보기와 동일 비율 |
| 스퀘어 이미지 | **1080×1080px** (1:1) | JPG / PNG | 대안 |

> LinkedIn 에셋과 사이즈 거의 동일 → 동일 파일 사용 가능.

### LinkedIn

| 에셋 유형 | 권장 사이즈 | 파일 형식 | 비고 |
|-----------|-------------|-----------|------|
| 피드 이미지 (메인) | **1200×628px** (1.91:1) | JPG / PNG | 가장 넓은 노출 |
| 스퀘어 이미지 | **1080×1080px** (1:1) | JPG / PNG | 대안 |

**LinkedIn 비주얼 특이사항:** 전문적 톤 → 브랜드 로고 + 핵심 수치/문구 강조. 과도한 게임 이미지보다 깔끔한 인포그래픽/카드 형식이 B2B 오디언스에 더 효과적.
